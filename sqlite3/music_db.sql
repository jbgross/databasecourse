...
insert into album (album_name, artist_name) values ('Beethovens Symphony #4', 'Ludwig von Beethoven');
...
insert into mp3 (mp3_id, title, length, album_title) values (1028, 'Allegro Vivace E Con Brio', 10.03, 'Beethovens Symphony #4');
insert into mp3 (mp3_id, title, length, album_title) values (1029, 'Allegretto Scherzando', 4.49, 'Beethovens Symphony #4');
insert into mp3 (mp3_id, title, length, album_title) values (1030, 'Temp Di Menuetto', 5.56, 'Beethovens Symphony #4');
insert into mp3 (mp3_id, title, length, album_title) values (1031, 'Allegro Vivace', 7.29, 'Beethovens Symphony #4');
