...
VALUES
    ...
    (1003, 'Darius', 'Patel', DATE '1987-07-19', 'Analyst', 65000.00),
    (1004, 'Elena', 'Martinez', DATE '1992-11-08', 'Manager', 90000.00),
    (1005, 'Farah', 'Khan', DATE '1989-02-14', 'Analyst', 65000.00),
    (1006, 'Gavin', 'Brooks', DATE '1983-05-27', 'Manager', 90000.00),
    (1007, 'Helena', 'Wright', DATE '1991-08-30', 'Analyst', 65000.00);
